    ...
    #                     print(html,"this is html")
            ...
            for row in rows:
                    ...
                    if short_sub in subnode_text :
                        ...
                        risks_button = row.find_element(By.XPATH, ".//a[@title='Model Answer']")

                        # Click the "Risks" button
                        risks_button.click()
                        break
            risk_url = driver.current_url
            driver.find_element(By.NAME,'short_answer').send_keys(test)
            driver.find_element(By.XPATH,'/html/body/section/div/div/div/div/div/form/div[2]/div[2]/div/div/div/div[3]/div[2]/p').send_keys(test)
            # driver.find_element(By.ID,'unit_assertion').click()
            
            
            driver.find_element(By.ID,'ansSubmit').click()
            ...
            short_name = driver.find_element(By.NAME,'short_answer')
            short_name.clear()
            upd = test+"update"
