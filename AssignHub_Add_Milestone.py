...
class AssignHub_add_MS:
    def AssignHub_add_MS():
        ...
        Assignment_field = driver.find_element(By.NAME,"assign_hub")
        Assignment_field.click()
        time.sleep(2)
        Search = driver.find_element(By.XPATH, "/html/body/div[8]/div/div/div[2]/div/div[2]/div/span/span[1]/span/span[1]").click()
        time.sleep(2)
        Search1 = driver.find_element(By.XPATH,"/html/body/span/span/span[1]/input")
        Search1.send_keys("Test Assignment 13")
        time.sleep(2)
        ...
        print_statements = []
        if check_element:
            # logging.info("Add Milestone page opened successfully")  # Log the message

            print("Add Milestone page opened successfully")
            print_statements.append("Add Milestone page opened successfully")
            pass
        else:
            # logging.info("not able to open Add_Milestone page")  # Log the message
    ...
    # Save the DataFrame to an Excel file
        ...
        excelsave = "Assignhub_Add_milestone"+str(unique_id)+".xlsx"
