...
class Standardised_reports:
                ...
                if add_element:
                    ...
                    if flow[i] == "add":
                        ...
                        try:
                            ...
                            #REPORT_name
                            field_element = driver.find_element(By.NAME ,'report_name')
                        ...
                        for j in input_element:
                            ...
                            try:
                                ...
                                print("check1")
                                time.sleep(1)                             
                                driver.find_element(By.NAME ,'report_name').send_keys(j)
                                time.sleep(0.2)
    ...
    #                     print(html,"this is html")
                        ...
                        driver.find_element(By.XPATH , '//*[@id="report_active_filter"]/label/input').send_keys(test)
